                    ...
                    private void callOpenAiApi(String prompt) {
                        ...
                        try {
                            ...
                            Request request = new Request.Builder()
                                    ...
                                    .header("Authorization", "Bearer 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") // Use your secured API key here
                                    .post(body)
                                    .build();
                            ...
                            client.newCall(request).enqueue(new Callback() {
                                ...
                                public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                                    if (response.isSuccessful()) {
                                        ...
                                        // Process the response (extract message or process it as needed)
                                        String result = extractApiResponse(responseBody);

                                        // Update the UI to display the result (on the main UI thread)
                                        getActivity().runOnUiThread(() -> {
                                            // Find the TextView and set the response text
                                            TextView responseTextView = getView().findViewById(R.id.responseTextView);
                                            responseTextView.setText(result);  // Display the API response
